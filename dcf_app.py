...
with tab4:
    ...
    def color_cell(val):
        ...
        if val < base_pps*0.85: return 'background-color:#ffffff; color:#1B3A6B; font-weight:bold'
    ...
    st.caption("🔵 Dark Navy = >15% above base · 🔷 Light Blue = base range · ⬜ White = >15% below base")
